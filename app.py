...
""")
    ...
    st.markdown("If you don't know the MSME status of the supplier and want to check ,as if they would fall under eligible category ,delete them from the below list, it will be treated as registered MSME.")
