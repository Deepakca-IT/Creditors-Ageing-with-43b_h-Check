...
""")
    ...
    st.markdown("**Edit MSME mapping (inline)** — Edit here.Any supplier included below and left blank will be treated as Non MSME registered.If you dnt know the MSME status of the supplier and wanted to check its payment status,delete the supplier detail below")
